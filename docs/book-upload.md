...
> [!IMPORTANT]
> **CAPYBARABR Tracker Exception**: For the **CAPYBARABR** tracker, different ebook formats _are_ considered duplicates under the `BOOK` category because this tracker only allows one format per book.
